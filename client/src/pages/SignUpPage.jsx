import { Mail, MessageSquare, User, Lock, Eye, EyeOff, Loader2 } from "lucide-react"; // Added missing icons
...
function SignUpPage() {
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2">
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="form-control">
                            ...
                            {/* FIXED: Icon must be inside a relative div for positioning */}
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            {/* Right Side - Usually an image or decorative component */}
            <div className="hidden lg:flex items-center justify-center bg-base-200">
               {/* You can add an AuthImagePattern component here later */}
            </div>
        </div>
    );
}
